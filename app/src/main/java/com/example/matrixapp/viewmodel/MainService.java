...
public class MainService extends VpnService {
    ...
    public void onCreate() {
        ...
        Tun2Socks.initialize(App.appContext); // load native libraries...
    ...
    private void createNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            stopPendingIntent = PendingIntent.getService(this, 1, stopIntent, PendingIntent.FLAG_IMMUTABLE);
        }

        PendingIntent contentPendingIntent =
                PendingIntent.getActivity(this, 2, new Intent(this, DrawerActivity.class), PendingIntent.FLAG_IMMUTABLE);
    ...
    private void startService() {
        if (isTun2SocksRunning) {
            Log.d("TAG", "seems vpn already running!?");
            return;
        }
